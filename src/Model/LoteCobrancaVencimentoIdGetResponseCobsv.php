 ...
 * @author   DB Seller
 */
class LoteCobrancaVencimentoIdGetResponseCobsv extends ModelResource implements ModelInterface
{
     ...
     * Sets status
     *
     * @param string $status Status da solicitação de criação/alteração da
     * cobrança no contexto de criação via lote
     * <table>
     *  <tr><td>ENUM</td></tr>
