...
/**
 * CobrancaImediataPostRequestValor Class Estrutura com
 * valores monetários referentes a cobrança do documento.
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancaImediataPostRequestValor extends ModelResource implements ModelInterface
{
     ...
     *
     * @param int $modalidade_alteracao Trata-se de um campo que
     * determina se o valor final do documento pode ser alterado
     * pelo pagador. Na ausência desse campo, assume-se que não se
     * pode alterar o valor do documento de cobrança, ou seja,
     * assume-se o valor 0. Se o campo estiver presente e com valor 1,
     * então está determinado que o valor final da cobrança pode ter
     * seu valor alterado pelo pagador.
     *
     * @return $this
     */
