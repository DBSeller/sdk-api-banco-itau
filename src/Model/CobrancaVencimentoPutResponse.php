...
/**
 * CobrancaVencimentoPutResponse Class
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancaVencimentoPutResponse extends ModelResource implements ModelInterface
{
     ...
     * possibilite a conciliação de pagamentos. O txid é criado exclusivamente
     * pelo usuário recebedor e está sob sua responsabilidade. Deve ser único
     * por CNPJ do recebedor. Para Code dinâmico o campo deve possuir de 26 posição
     * até 35 posições. Os caracteres permitidos no contexto do Pix para o campo txId
     * são: Letras minúsculas, de ‘a’ a ‘z’, Letras maiúsculas, de ‘A’ a ‘Z’, Dígitos
     * decimais, de ‘0’ a ‘9’
     *
     * @return $this
     */
     ...
     *
     * @param string $pix_copia_e_cola Este campo retorna o valor do Pix Copia e
     * Cola correspondente à cobrança. Trata-se da sequência de caracteres que
     * representa o BR Code.
     *
     * @return $this
     */
