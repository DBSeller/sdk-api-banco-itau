...
/**
 * CobrancaPatchResponseCalendario Class Os campos
 * aninhados sob o identificador calendário e que
 * organizam informações a respeito de controle d
 * tempo da cobrança
 *
 * @category Model
 ...
 * @author   DBSeller
 */
class CobrancaPatchResponseCalendario extends ModelResource implements ModelInterface
{
     ...
     * Sets expiracao
     *
     * @param int $expiracao Tempo de vida da cobrança,especificado
