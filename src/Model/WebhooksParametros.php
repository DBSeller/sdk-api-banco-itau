 ...
 * @author   DB Seller
 */
class WebhooksParametros extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        'inicio' => 'string',
        'fim' => 'string',
        'paginacao' => '\DBSeller\SdkBancoItau\Model\WebhooksParametrosPaginacao'
    ];
     ...
     * Gets paginacao
     *
     * @return \DBSeller\SdkBancoItau\Model\WebhooksParametrosPaginacao
     */
     ...
     * Sets paginacao
     *
     * @param \DBSeller\SdkBancoItau\Model\WebhooksParametrosPaginacao $paginacao paginacao
     *
     * @return $this
     */
