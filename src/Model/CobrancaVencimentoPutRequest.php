...
/**
 * CobrancaVencimentoPutRequest Class
 *
 * @category Model
 * @package  DBSeller\ApiPixItau
 * @author   DBSeller
 */
class CobrancaVencimentoPutRequest extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        ...
        'valor' => '\DBSeller\SdkBancoItau\Model\CobrancaVencimentoPutRequestValor',
        'loc' => 'object',
        'chave' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['calendario'] = $this->hasIndex(
            'calendario',
            $data
        );
     ...
     * Gets valor
     *
     * @return \DBSeller\SdkBancoItau\Model\CobrancaVencimentoPutRequestValor
     */
     ...
     * Sets valor
     *
     * @param \DBSeller\SdkBancoItau\Model\CobrancaVencimentoPutRequestValor $valor valor
     *
     * @return $this
     */
