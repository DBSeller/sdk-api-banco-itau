...
/**
 * CobrancaPutResponseValor Class Estrutura
 * com valores monetários referentes a cobrança do documento.
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancaPutResponseValor extends ModelResource implements ModelInterface
{
     ...
     *
     * @param int $modalidade_alteracao Modalidade de Alteração.
     * Trata-se de um campo que determina se o valor final do
     * documento pode ser alterado pelo pagador.
     *
     * @return $this
     */
