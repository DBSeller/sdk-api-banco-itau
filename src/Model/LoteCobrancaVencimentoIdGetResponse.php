 ...
 * @author   DB Seller
 */
class LoteCobrancaVencimentoIdGetResponse extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        ...
        'criacao' => 'string',
        'descricao' => 'string',
        'cobsv' => '\DBSeller\SdkBancoItau\Model\LoteCobrancaVencimentoIdGetResponseCobsv[]'
    ];
     ...
     * Gets cobsv
     *
     * @return \DBSeller\SdkBancoItau\Model\LoteCobrancaVencimentoIdGetResponseCobsv[]
     */
     ...
     * Sets cobsv
     *
     * @param \DBSeller\SdkBancoItau\Model\LoteCobrancaVencimentoIdGetResponseCobsv[] $cobsv Dados enviados para criação
