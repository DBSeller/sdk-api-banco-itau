...
/**
 * CobrancasVencimentoParametrosPaginacao Class
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancasVencimentoParametrosPaginacao extends ModelResource implements ModelInterface
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['quantidade_de_paginas']     = $this->hasIndex('quantidade_de_paginas', $data);
        $this->container['quantidade_total_de_itens'] = $this->hasIndex('quantidade_total_de_itens', $data);
    }
     ...
     *
     * @param int $quantidade_total_de_itens Quantidade total de itens disponíveis
