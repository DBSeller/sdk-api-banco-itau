 ...
 * @author   DB Seller
 */
class ParametrosPaginacao extends ModelResource implements ModelInterface
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['quantidade_de_paginas'] = isset($data['quantidade_de_paginas']) ?
            $data['quantidade_de_paginas'] : null;
        $this->container['quantidade_total_de_itens'] = isset($data['quantidade_total_de_itens']) ?
            $data['quantidade_total_de_itens'] : null;
    }
     ...
     *
     * @param int $quantidade_total_de_itens Quantidade total de itens disponíveis de acordo com os parâmetros
     * informados.
     *
     * @return $this
     */
