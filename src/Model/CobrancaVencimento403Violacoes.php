...
/**
 * CobrancaVencimento403Violacoes Class
 *
 * @category Model
 * @package  DBSeller\ApiPixItau
 * @author   DBSeller
 */
class CobrancaVencimento403Violacoes extends ModelResource implements ModelInterface
{
    ...
    {
        $this->container['razao']       = $this->hasIndex('razao', $data);
        $this->container['propriedade'] = $this->hasIndex('propriedade', $data);
