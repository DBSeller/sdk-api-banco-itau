...
/**
 * CobrancasVencimentoCobs Class
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancasVencimentoCobs extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        'calendario'          => '\DBSeller\SdkBancoItau\Model\Calendario',
     ...
     * Gets calendario
     *
     * @return \DBSeller\SdkBancoItau\Model\Calendario
     */
     ...
     * Sets calendario
     *
     * @param \DBSeller\SdkBancoItau\Model\Calendario $calendario calendario
     *
     * @return $this
     */
     ...
     *
     * @param string $solicitacao_pagador O campo solicitacaoPagador, determina
     * um texto a ser apresentado ao pagador para que ele possa digitar uma
     * informação correlata, em formato livre, a ser enviada ao recebedor
     *
     * @return $this
     */
     ...
     *
     * @param string $pix_copia_e_cola Este campo retorna o valor
     * do Pix Copia e Cola correspondente à cobrança. Trata-se da
     * sequência de caracteres que representa o BR Code.
     *
     * @return $this
     */
