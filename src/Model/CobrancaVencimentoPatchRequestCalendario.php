...
/**
 * CobrancaVencimentoPatchRequestCalendario Class
 * Os campos aninhados sob o identificador calendário e
 * que organizam informações a respeito de controle de tempo da cobrança
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model;
 * @author   DBSeller
 */
class CobrancaVencimentoPatchRequestCalendario extends ModelResource implements ModelInterface
{
    ...
    {
        $this->container['data_de_vencimento']       = $this->hasIndex('data_de_vencimento', $data);
        $this->container['validade_apos_vencimento'] = $this->hasIndex('validade_apos_vencimento', $data);
    }
     ...
     *
     * @param int $validade_apos_vencimento Quantidade de dias
     * corridos após o vencimento em que a cobrança poderá ser paga
     *
     * @return $this
     */
