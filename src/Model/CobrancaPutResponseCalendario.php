...
/**
 * CobrancaPutResponseCalendario Class Os campos
 * aninhados sob o identificador calendário e que
 * organizam informações a respeito de controle de
 * tempo da cobrança
 *
 * @category Model
 ...
 * @author   DBSeller
 */
class CobrancaPutResponseCalendario extends ModelResource implements ModelInterface
{
     ...
     * Sets expiracao
     *
     * @param int $expiracao Tempo de vida da cobrança,
     * especificado em segundos a partir da data de criação (Calendario.criacao).
     *
     * @return $this
     */
