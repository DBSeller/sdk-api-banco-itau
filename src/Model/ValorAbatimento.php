 ...
 * @author   DB Seller
 */
class ValorAbatimento extends ModelResource implements ModelInterface
{
     ...
     * Sets modalidade
     *
     * @param int $modalidade Modalidade de abatimento
     * <table>
     *  <tr><td>Descrição</td><td>Dominio</td></tr>
     *  <tr><td>Valor Fixo</td><td>1</td></tr>
     *  <tr><td>Percentual</td><td>2</td></tr>
     * </table>
     *
     * @return $this
     */
     ...
     * Sets valor_perc
     *
     * @param string $valor_perc Abatimentos ou outras deduções
     * aplicadas ao documento, em valor absoluto ou percentual
     * do valor original do documento.
     *
     * @return $this
     */
