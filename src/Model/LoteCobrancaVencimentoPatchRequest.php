 ...
 * @author   DB Seller
 */
class LoteCobrancaVencimentoPatchRequest extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        'descricao' => 'string',
        'cobsv' => '\DBSeller\SdkBancoItau\Model\LoteCobrancaVencimentoPatchRequestCobsv[]'
    ];
     ...
     * Gets cobsv
     *
     * @return \DBSeller\SdkBancoItau\Model\LoteCobrancaVencimentoPatchRequestCobsv[]
     */
     ...
     * Sets cobsv
     *
     * @param \DBSeller\SdkBancoItau\Model\LoteCobrancaVencimentoPatchRequestCobsv[] $cobsv Dados enviados para criação
