...
/**
 * CobrancaPatchResponse Class
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancaPatchResponse extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        ...
        'valor'               => '\DBSeller\SdkBancoItau\Model\CobrancaPropertiesValor',
        'chave'               => 'string',
        'solicitacao_pagador' => 'string',
        'calendario'          => '\DBSeller\SdkBancoItau\Model\CobrancaPatchResponseCalendario',
     ...
     * Gets valor
     *
     * @return \DBSeller\SdkBancoItau\Model\CobrancaPropertiesValor
     */
     ...
     * Sets valor
     *
     * @param \DBSeller\SdkBancoItau\Model\CobrancaPropertiesValor $valor valor
     *
     * @return $this
     */
     ...
     * Gets calendario
     *
     * @return \DBSeller\SdkBancoItau\Model\CobrancaPatchResponseCalendario
     */
     ...
     * Sets calendario
     *
     * @param \DBSeller\SdkBancoItau\Model\CobrancaPatchResponseCalendario $calendario calendario
     *
     * @return $this
     */
     ...
     * Copia e Cola correspondente à cobrança. Trata-se da sequência
