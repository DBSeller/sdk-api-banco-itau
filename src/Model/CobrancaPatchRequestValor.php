...
/**
 * CobrancaPatchRequestValor Class Estrutura com
 ...
 * @author   DBSeller
 */
class CobrancaPatchRequestValor extends ModelResource implements ModelInterface
{
     ...
     * pelo pagador. Na ausência desse campo, assume-se que não
     * se pode alterar o valor do documento de cobrança, ou seja,
     * assume-se o valor 0. Se o campo estiver presente e com valor
     * 1, então está determinado que o valor final da cobrança pode
     * ter seu valor alterado pelo pagador.
     *
     * @return $this
     */
