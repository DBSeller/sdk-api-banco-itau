...
/**
 * CobrancaVencimento403 Class
 *
 * @category Model
 * @package  DBSeller\ApiPixItau\Model
 * @author   DBSeller
 */
class CobrancaVencimento403 extends ModelResource implements ModelInterface
{
     ...
     * Sets correlation_id
     *
     * @param string $correlation_id Identificador de correlação do
     * problema para fins de suporte
     *
     * @return $this
     */
     ...
     * Devoluções registradas no documento
     *
     * @return $this
     */
