...
/**
 * CobrancasVencimentoParametros Class
 *
 * @category Model
 * @package  DBSeller\SdkBancoItau\Model
 * @author   DBSeller
 */
class CobrancasVencimentoParametros extends ModelResource implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => 'bool',
        'paginacao' => '\DBSeller\SdkBancoItau\Model\CobrancasVencimentoParametrosPaginacao'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tx_id_presente'] = $this->hasIndex(
            'tx_id_presente',
            $data
        );

        $this->container['devolucao_presente'] = $this->hasIndex(
            'devolucao_presente',
            $data
        );

        $this->container['location_presente'] = $this->hasIndex(
            'location_presente',
            $data
        );
    }
     ...
     * recebedor e está sob sua responsabilidade. Deve ser único por CNPJ do recebedor.
     * Apesar de possuir o tamanho de 35 posições (PAC008), para QR Code Estático o
     * tamanho máximo permitido é de 25 posições (limitação EMV). No caso do QR Code
     ...
     * Gets paginacao
     *
     * @return \DBSeller\SdkBancoItau\Model\CobrancasVencimentoParametrosPaginacao
     */
     ...
     * Sets paginacao
     *
     * @param \DBSeller\SdkBancoItau\Model\CobrancasVencimentoParametrosPaginacao $paginacao paginacao
     *
     * @return $this
     */
