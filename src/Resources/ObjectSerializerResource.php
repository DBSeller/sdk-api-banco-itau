 ...
 * @author   DBSeller
 */
class ObjectSerializerResource
{
    /**
     * Swagger Type
     *
     * @var string[] $swaggerType
     */
    private static $swaggerType = [
        'DateTime',
        'bool',
        'boolean',
        'byte',
    ...
    public static function sanitizeForSerialization($data, $format = null)
    {
        if (is_scalar($data) || null === $data) {
            ...
            foreach ($data::swaggerTypes() as $property => $swaggerType) {
                ...
                if ($value !== null
                    && !in_array($swaggerType, self::$swaggerType, true)
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        } elseif (in_array($class, self::$swaggerType, true)) {
            settype($data, $class);
